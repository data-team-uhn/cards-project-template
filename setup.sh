...
(docker image inspect cards/cards:latest > /dev/null 2>/dev/null) && (LOCAL_CARDS_VERSION=$(docker run --rm  --entrypoint /bin/sh cards/cards:latest -c "ls /root/.m2/repository/io/uhndata/cards/cards-parent/ | grep SNAPSHOT"))
declare VERSION
declare HAS_DEFAULT
